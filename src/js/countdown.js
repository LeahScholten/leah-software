const eersteKerstdag = new Date(2021, 11, 25)
const tweedeKerstdag = new Date(2021, 11, 26)
const nieuwjaar = new Date(2022, 0)
const oudjaar = new Date(2021, 11, 31)
const now = new Date()
...
if(now.getTime() < eersteKerstdag.getTime()){
    countDown.innerHTML = `dagen tot eerste kerstdag: ${Math.ceil((eersteKerstdag.getTime() - now.getTime()) / 1000 / 3600 / 24)}<br/>` +
                          ...
                          `dagen tot 2022: ${Math.ceil((nieuwjaar.getTime() - now.getTime()) / 1000 / 3600 / 24)}`
    ...
    countDown.innerHTML = `dagen tot 2022: ${Math.ceil((nieuwjaar.getTime() - now.getTime()) / 1000 / 3600 / 24)}`
}else if(now.getTime() < nieuwjaar){
    const tijd = nieuwjaar.getTime() - now.getTime()
    countDown.innerHTML = `tijd tot 2022: ${Math.floor(tijd / 3600 / 1000)}:${Math.floor(tijd / 1000 / 60 % 60)}:${Math.floor(tijd / 1000 % 60)}`
